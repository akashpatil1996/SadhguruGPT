...
st.markdown("<h4 style='text-align: center; font-size: 14px; color: white; background-color: grey; padding: 4px;'>AI-Chatbot trained on the wisdom of Sadhguru. It provides responses inspired by his books and discourses.</h4>", unsafe_allow_html=True)
